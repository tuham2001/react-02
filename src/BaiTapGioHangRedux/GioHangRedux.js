...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    tangGiamSoLuong: (maSP, tangGiam) => { //tangGiam = true => xử lý tăng, false => xử lý giảm
      let action = {
        type: 'TANG_GIAM_SO_LUONG', // Thuộc tính bắt buộc để biết chạy vào case nào trong Reducer
        maSP,
        tangGiam
      }
      dispatch(action)
